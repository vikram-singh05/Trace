      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.4)] relative bg-white/90 dark:bg-earth-900/90 backdrop-blur-3xl backdrop-saturate-200 border border-earth-200/50 dark:border-earth-700/50 rounded-3xl"
          ...
          >
            ...
            <div className="p-6 pt-2 bg-white/30 dark:bg-earth-900/20">
              <motion.button 
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={handleClose}
                className="w-full py-3.5 rounded-2xl font-bold text-sm bg-gradient-to-br from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white shadow-[0_4px_16px_rgba(212,175,55,0.25)] hover:shadow-[0_6px_24px_rgba(212,175,55,0.4)] border border-gold-600/50 transition-all flex items-center justify-center"
              >
                {buttonText}
              </motion.button>
            </div>
